...
public abstract class GUI {
    ...
    protected abstract void setDistanceMode(Boolean b);

    protected abstract void togglePathFindingMode();
    ...
    public JComboBox<String> getComboBox(){return box;}
    ...
    private void initialise() {
        ...
        JButton dist = new JButton("Distance mode");
        ...
        JButton time = new JButton("Time mode");
        ...
        JToggleButton pathfindMode = new JToggleButton("Path finding");
        pathfindMode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
        ...
        pathfindMode.setMaximumSize(new Dimension(50, 200));
        ...
        loadquit.add(load);
        loadquit.add(quit);
        JPanel disttime = new JPanel();
        disttime.setLayout(new GridLayout(2, 1));
        // manually set a fixed size for the panel containing the load and quit
        // buttons (doesn't change with window resize).
        disttime.setMaximumSize(new Dimension(75, 100));
        disttime.add(dist);
        disttime.add(time);
        ...
        controls.add(Box.createRigidArea(new Dimension(15, 0)));
        controls.add(disttime);
        controls.add(pathfindMode);
        controls.add(Box.createRigidArea(new Dimension(15, 0)));
